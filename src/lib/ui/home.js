export default () => {
  ...
  <div>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <section class="color-b mask rgba-black-light">
                            ...
                            <div id="carouselExampleCaptions" class="carousel slide color-b" data-ride="carousel">
                              ...
                              <div class="carousel-inner color-b mask rgba-black-light">
                                <div class="carousel-item active">
                                  <img src="https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" class="d-block w-100 h-50  color-b" alt="...">
                                ...
                                <div class="carousel-item">
                                  <img src="https://images.unsplash.com/photo-1517677208171-0bc6725a3e60?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80" class="d-block w-100 h-50 color-b" alt="...">
                                  <div class="carousel-caption d-none d-md-block">
                                ...
                                <div class="carousel-item">
                                  <img src="https://images.unsplash.com/photo-1530490125459-847a6d437825?ixlib=rb-1.2.1&auto=format&fit=crop&w=763&q=80" class="d-block w-100 h-50 color-b " alt="...">
                                  <div class="carousel-caption d-none d-md-block">
